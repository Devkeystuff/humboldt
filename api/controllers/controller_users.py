...
from models.common.token_data import TokenData
from models.common.token import Token
from jose import JWTError, jwt
from passlib.context import CryptContext
from routers.router_auth import fake_users_db
...
def get_current_user(token: str = Depends(oauth2_scheme)):
    ...
    try:
        payload = jwt.decode(
            token, os.getenv("ACCESS_TOKEN_SECRET"), algorithms=[os.getenv("ALGORITHM")]
        )
