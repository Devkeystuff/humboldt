        ...
        <div className="StepsDiv">
          <div>
            ...
            <p className="steps-tutorial">
              Select a place you would like to display on your merch
            </p>
          </div>
          <div>
            ...
            <p>CUSTOMIZE</p>
            <p className="steps-tutorial">
              Uniquely customize merch to your own liking and write a
          ...
          <div>
            ...
            <p>ORDER</p>
            <p className="steps-tutorial">
              Finalize the process by filling in the necessary payment
              information
            </p>
          </div>
        </div>
